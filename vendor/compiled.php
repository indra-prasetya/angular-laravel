...
class Carbon extends DateTime
{
    ...
    public static function setLocale($locale)
    {
        ...
        static::translator()->addResource('array', require '/var/www/html/ng-laravel/vendor/nesbot/carbon/src/Carbon' . '/Lang/' . $locale . '.php', $locale);
    }
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        $this->app->bind('Illuminate\\Contracts\\Auth\\Registrar', 'Todo\\Services\\Registrar');
    }
}
namespace Todo\Providers;
...
class BusServiceProvider extends ServiceProvider
{
    public function boot(Dispatcher $dispatcher)
    {
        $dispatcher->mapUsing(function ($command) {
            return Dispatcher::simpleMapping($command, 'Todo\\Commands', 'Todo\\Handlers\\Commands');
        });
    }
    public function register()
    {
